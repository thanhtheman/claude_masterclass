...
argument-hint: "[Short feature description, optinally: 'figma: <component-link>']"
...
- Trim whitespace.
- Example input:
- /specs Card component, figma: https://www.figma.com/design/some-link
...
Use the **figma-design-extractor** subgagent to provide guide for the feature, citing the `figma-hint` and tell it to:
